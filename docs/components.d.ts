...
declare module 'vue' {
  export interface GlobalComponents {
    DocSidePanel: typeof import('./src/components/DocSidePanel.vue')['default']
    ...
    IMdiBookOpenPageVariantOutline: typeof import('~icons/mdi/book-open-page-variant-outline')['default']
